  ...
  return (
    <div className="px-4 flex flex-col gap-10 py-24">
      <div className="max-w-7xl mx-auto flex flex-col gap-4 w-full">
        ...
        <p>
          Si tiene alguna pregunta sobre esta Política de Privacidad, puede contactarnos a través de la aplicación o en nuestro correo electrónico de soporte.
        </p>
      </div>
    </div>
  )
